...
function App() {
    ...
    const closeKeyForm = () => { setShowKeyForm(false); setEditingKeyId(null); setKeyForm({ id: '', name: '', projectId: '', internalLimit: '2000' }); setKeyFormError('') }
    const editKey = (key: KeySummary) => { setEditingKeyId(key.id); setKeyForm({ id: key.id, name: key.name, projectId: key.projectId, internalLimit: String(key.internalLimit) }); setShowKeyForm(true) }
